    ...
    <div class="container sale">
        <div class="row">
            <div class="content-sale col-md-8">
                @if(isset($listNewsRE) && count($listNewsRE) > 0)
            ...
            <div class="side-bar col-md-4">
                ...
                <div class="sell-home">
                    ...
                    @if(isset($tagChild) && $tagChild->count() > 0)
                    <div class="category-sell-home">
                        <p><a href="{!! URL::route('dashboard.realestale.tag', array('slug'=>$tagRE->slug)) !!}" title="">{!! $tagRE->name !!}</a></p>
                        @foreach($tagChild as $tc)
                        <p><a href="{!! URL::route('dashboard.realestale.tag', array('slug'=>$tc->slug)) !!}" title="">{!! $tc->name !!}</a></p>
                        @endforeach
                    </div>
                    @endif
                </div>
