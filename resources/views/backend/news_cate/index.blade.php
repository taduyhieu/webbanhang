...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(".publish").bind("click", function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "{!! url(getLang() . '/admin/news-cate/" + id + "/toggle-publish/') !!}",
                headers: {
...
<section class="content-header">
    <h1>
        Quản lý bài viết hiển thị nổi bật chuyên mục
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!! URL::route('admin.dashboard') !!}">Dashboard</a></li>
        <li class="active"> Quản lý bài viết hiển thị nổi bật chuyên mục</li>
    </ol>
</section>
<br>
<div class="container">
    <div class="row">
        ...
        <br>
        <div class="col-lg-6">
            <form action="{{ route('admin.news-cate.search') }}" method="get" class="form-inline pull-left">
    ...
    <div class="col-lg-12">
        @if($newsCate->count())
        <div class="row">
            {!! Form::open(array('action' => '\Fully\Http\Controllers\Admin\NewsCateController@update', 'method' => 'PATCH')) !!}
            {!! csrf_field() !!}
