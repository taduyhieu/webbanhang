...
@section('content')
    ...
    <section class="content-header">
        <h1> {{ trans('fully.contact_form') }} <small> | {{ trans('fully.create') }}</small> </h1>
        <ol class="breadcrumb">
    ...
    <br>
    <div class="container">
        {!! Form::open(array('action' => '\Fully\Http\Controllers\Admin\ContactController@store', 'files'=>true)) !!}
        ...
        <div class="control-group {!! $errors->has('company_name') ? 'has-error' : '' !!}">
            ...
            <div class="controls"> {!! Form::text('company_name', null, array('class'=>'form-control', 'id' => 'company_name', 'placeholder'=>trans('fully.contact_name'), 'value'=>Input::old('company_name'))) !!}
        ...
        <div class="control-group {!! $errors->has('address') ? 'has-error' : '' !!}">
            ...
            <div class="controls"> {!! Form::text('address', null, array('class'=>'form-control', 'id' => 'address', 'placeholder'=>trans('fully.address'), 'value'=>Input::old('address'))) !!}
        ...
        <div class="control-group {!! $errors->has('phone_number') ? 'has-error' : '' !!}">
            ...
            <div class="controls"> {!! Form::text('phone_number', null, array('class'=>'form-control', 'id' => 'phone_number', 'placeholder'=>trans('fully.phone'), 'value'=>Input::old('phone_number'))) !!}
        ...
        <div class="control-group {!! $errors->has('email') ? 'has-error' : '' !!}">
            ...
            <div class="controls"> {!! Form::text('email', null, array('class'=>'form-control', 'id' => 'email',
        ...
        <div class="control-group {!! $errors->has('url_map') ? 'has-error' : '' !!}">
            ...
            <div class="controls"> {!! Form::textarea('url_map', null, array('class'=>'form-control', 'id' => 'url_map', 'placeholder'=>'Url map', 'value'=>Input::old('url_map'))) !!}
        ...
        <div class="control-group {!! $errors->has('is_published') ? 'has-error' : '' !!}">
            <div class="controls">
                <label class="">{!! Form::checkbox('is_published', 'is_published') !!} {{ trans('fully.public_img') }} ?</label>
                @if ($errors->first('is_published'))
                    <span class="help-block">{!! $errors->first('is_published') !!}</span> @endif </div>
        </div>
        <br> 

        {!! Form::submit(trans('fully.save'), array('class' => 'btn btn-success')) !!} {!! Form::close() !!}
        <br>
    </div>
@stop