...
<section class="content-header">
    <h1> {{trans('fully.photo_title')}} <small> | {{trans('fully.photo_new')}}</small> </h1>
    <ol class="breadcrumb">
        <li><a href="{!! url(getLang(). '/admin/photo-gallery') !!}"><i class="fa fa-desktop"></i> {{trans('fully.photo_title')}}</a></li>
        <li class="active">{{trans('fully.photo_new')}}</li>
    </ol>   
</section>
<br>
<br>
<div class="container">
    <!-- Dropzone -->
    <label class="control-label" for="title">{{trans('fully.photo_edit_title')}}</label>
    ...
    <div class="control-group {!! $errors->has('title') ? 'has-error' : '' !!}">
        <label class="control-label" for="title">{{trans('fully.photo_gallery_name')}}</label>

        <div class="controls">
            {!! Form::text('title', $photo_gallery->title, array('class'=>'form-control', 'id' => 'title', 'placeholder'=>trans('fully.photo_gallery_name'), 'value'=>Input::old('title'))) !!}
    ...
    <div class="control-group {!! $errors->has('content') ? 'has-error' : '' !!}">
        <label class="control-label" for="title">{{trans('fully.conent')}}</label>

        <div class="controls">
            {!! Form::textarea('content', $photo_gallery->content, array('class'=>'form-control', 'id' => 'content', 'placeholder'=>trans('fully.conent'), 'value'=>Input::old('content'))) !!}
    ...
    <div class="control-group {!! $errors->has('is_published') ? 'has-error' : '' !!}">
        ...
        <div class="controls">
            <label class="">{!! Form::checkbox('is_published', 'is_published',$photo_gallery->is_published) !!} {{trans('fully.public_img')}} ?</label>
