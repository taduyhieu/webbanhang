        ...
        <div class="row">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{!! ++$key !!}</td>
                        <td> {!! link_to_route( getLang() . '.admin.product.show', $value->product_name,
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="{!! langRoute('admin.product.show', array($value->id)) !!}">
                                            <span class="glyphicon glyphicon-eye-open"></span>&nbsp;{!!trans('fully.show')!!} </a>
                                    </li>
                                    <li>
                                        <a href="{!! langRoute('admin.product.edit', array($value->id)) !!}">
                                            <span class="glyphicon glyphicon-edit"></span>&nbsp;{!!trans('fully.edit')!!}
                                        </a>
                                    </li>
                                    <li class="divider"></li>
                                    <li>
                                        <a href="{!! URL::route('admin.product.delete', array($value->id)) !!}">
