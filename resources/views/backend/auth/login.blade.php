...
<div class="login-box">
    ...
    <div class="login-box-body">
        <p class="login-box-msg">{{ trans('fully.auth_login') }}</p>
            {!! Form::open(array()) !!}
            {!! csrf_field() !!}
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                            <input type="checkbox"> {{ trans('fully.auth_remem') }}
                        </label>
                    </div>
                </div><!-- /.col -->
                <div class="col-xs-4">
                    <button type="submit" class="btn btn-primary btn-block btn-flat">{{ trans('fully.auth_login') }}</button>
                </div><!-- /.col -->
            </div>
        {!! Form::close() !!}
...
<!--        <div class="social-auth-links text-center">
        ...
        <a href="{!! route('admin.forgot.password') !!}">{{ trans('fully.auth_forgot') }} ?</a><br>
