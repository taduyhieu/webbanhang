    ...
    <div class="container">
        <div class="row">
            <div style="text-align: center" class="col-md-4 col-md-offset-4">
                <h1 style="color: #FFFFFF">Alberta CMS</h1>

                <div class="panel panel-default">
                    <div class="panel-body">
                        <h5 class="text-center"><b>{{ trans('fully.auth_reset_pass') }}</b></h5>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                {!! Form::label( trans('fully.auth_input') ) !!}
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
                                {!! Form::label( trans('fully.auth_re_input') ) !!}
                        ...
                        <br>
                        {!! Form::submit( trans('fully.save') , array('class' => 'btn btn-sm btn-primary btn-block', 'role'=>'button')) !!}
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
