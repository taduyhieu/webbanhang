        ...
        <div class="row">
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th>Stt</th>
                        <th>{!!trans('fully.cate_name')!!}</th>
                        <th>{!!trans('fully.cate_info_parent')!!}</th>
                        <th>{!!trans('fully.cate_info_url')!!}</th>
                        <th>Trạng thái</th>
                        <th></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        <td>{!! ++$key !!}</td>
                        <td> {!! link_to_route( getLang() . '.admin.categories.show', $category->title,
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="{!! langRoute('admin.categories.show', array($category->id)) !!}">
                                            <span class="glyphicon glyphicon-eye-open"></span>&nbsp;{!!trans('fully.show')!!} </a>
                                    </li>
                                    <li>
                                        <a href="{!! langRoute('admin.categories.edit', array($category->id)) !!}">
                                            <span class="glyphicon glyphicon-edit"></span>&nbsp;{!!trans('fully.edit')!!}
                                        </a>
                                    </li>
                                    <li class="divider"></li>
                                    <li>
                                        <a href="{!! URL::route('admin.categories.delete', array($category->id)) !!}">
