...
<section class="content-header">
    <h1>
        {!! trans('fully.menu_form') !!}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!! URL::route('admin.dashboard') !!}">Dashboard</a></li>
        <li class="active">{{trans('fully.menu_form')}}</li>
    </ol>
</section>
...
<div class="col-lg-10">
    ...
    <br> <a href="{!! langRoute('admin.menu.create') !!}" class="btn btn-primary">
        <span class="glyphicon glyphicon-plus"></span>&nbsp; {!! trans('fully.menu_add') !!}</a> <br>
    <hr>
    <div class="dd" id="nestable">
        {!! $menus !!}
    </div>
    @if($menus === null)
    <div class="alert alert-danger">{{trans('fully.menu_not_found_data')}}</div>
    @endif
</div>
