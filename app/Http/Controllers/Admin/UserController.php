...
//        $file = null;
//        if ($request->get('user_image') != null) {
//            $fileName = $request->get('user_image');
//        }
//
//        if ($fileName) {
...
//
//            $user_image = $this->imgDir . $fileName;
//        }
//        if ($file == null) {
//            $user_image = resource_path() . '/public/assets/images/default-avt.png';
//        }
        ...
        $formData = array(
            ...
            'roles' => $request->get('account-role'),
//            'user_image' => $user_image,
        ...
        $messages = array(
            ...
            'user_name.required' => trans('fully.val_user_user_name'),
            'user_name.min' => trans('fully.val_user_min_user_name'),
            'user_name.unique' => trans('fully.val_user_name_unique'),
        );
...
//                    'user_image' => $formData['user_image'],
        ...
        if (isset($formData['roles'])) {
            //$formData['roles'] = Sentinel::findRoleByName($formData['roles']);
